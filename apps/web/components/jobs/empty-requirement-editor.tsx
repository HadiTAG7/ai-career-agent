...
export function EmptyRequirementEditor({ locale, onAdd, onBack }: { locale: Locale; onAdd: (input: RequirementInput) => Promise<void>; onBack: () => void }) {
  ...
  return (
    <section className="w-full max-w-xl border-y border-border py-7" aria-labelledby="empty-requirements-title">
      ...
      <form className="mt-6 space-y-4 border-t border-border pt-6 text-start" onSubmit={handleSubmit}>
