  ...
  return (
    <div className="page-wrap page-enter max-w-[900px]">
      ...
      <div className="mt-8 divide-y divide-border border-y border-border">
        ...
        <section className="py-7"><h2 className="section-title flex items-center gap-2"><ShieldCheck className="h-5 w-5 text-emerald" />{locale === "ar" ? "الخصوصية" : "Privacy"}</h2><p className="mt-3 text-sm text-muted">{locale === "ar" ? "لا توجد تحليلات استخدام في هذا الإصدار: لا يُجمع أي شيء ولا يُرسل. سيظهر خيار حقيقي هنا إذا أُضيفت تحليلات مستقبلًا." : "There are no usage analytics in this release: nothing is collected or sent. A real control will appear here if analytics are ever added."}</p></section>
