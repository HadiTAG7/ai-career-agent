...
- أسرار Render معرفة بـ`sync: false` ولا توجد أسرار حقيقية في المستودع. نطاقات
  Vercel العامة المسموح بها مصرح بها صراحة في `render.yaml` حتى تتطابق CORS وClerk.
